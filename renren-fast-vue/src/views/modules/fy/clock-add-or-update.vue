  ...
  <el-dialog
    ...
    <el-form :model="dataForm"  ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="80px">
      ...
      <!-- <el-form-item label="打卡时间" prop="createTime">
        <el-input v-model="dataForm.createTime" placeholder="打卡时间"></el-input> -->
      
      <el-form-item label="是否接触感染人员" prop="grjc">
        <el-input v-model="dataForm.grjc" placeholder="是否接触感染人员"></el-input>
      </el-form-item>
       <el-form-item label="上次核酸检测信息" prop="bz">
         <el-input v-model="dataForm.bz" placeholder="检测信息+时间(如：阴性，2022-4-22)"></el-input>
       </el-form-item>
    </el-form>
