...
public class TestScrewMain {
    ...
    private static final String DB_NAME = "renren_zxys?useUnicode=true&characterEncoding=UTF-8&serverTimezone=Asia/Shanghai";
    ...
    private static final String DOC_FILE_NAME = "装修验收数据库表设计文档";
    private static final String DOC_VERSION = "V1.0.0";
    private static final String DOC_DESCRIPTION = "装修验收数据库表设计描述";
